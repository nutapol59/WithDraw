...
public class AbstractReportJasperPDF {
    protected static final Logger LOGGER = LoggerFactory.getLogger(com.ss.util.AbstractReportJasperPDF.class);
    ...
    public static JasperPrint exportReport(String jasperFileName, List list, Map<String, Object> params) {
        ...
        try {
            ...
            Class cls = Class.forName("com.ss.util.AbstractReportJasperPDF");
